...
<body>
    ...
    <div class="sidebar">
        ...
        <!-- <img src="img/ow.jpeg" style="width:50%; "> -->
                    ...
                    <form method="post" id="userForm">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="form-group"> <label for="firstName" class="control-label">First
                                        Name*</label>
                                ...
                                <div class="form-group"><label for="username" class="control-label">Specility*</label>
                                    <!-- <select class="form-control" id="specility" name="specility"
                                        required>Specility</select>
                                    <option></option> -->
                                </div>
            ...
            <div id="userDetails" class="modal fade">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title"><i class="fa fa-plus"></i> Students Details</h4>
                        </div>
                        <div class="modal-body">
