            ...
            <div class="projects">
                <div class="card">
                    <div class="card-header">
                        <h3>Exam (<?php echo $_GET['exam_id']; ?>) Questions</h3>
                        <!-- 
                        ...
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-md-2" align="right">
                                    <button type="button" id="addQuestions" class="btn btn-info"
                                        title="Add Questions"><span class="glyphicon glyphicon-plus"></span></button>
                                </div>
                            </div>
                        </div>
